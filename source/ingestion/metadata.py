...
class ChunkMetadata(BaseModel):
    ...
    source_file: str
    file_type: str
    page: Optional[int] = Field(default=None, description="Số trang (nếu là PDF/Doc)")
    chunk_index: int = Field(..., description="Thứ tự của chunk trong tài liệu")
    content_hash: str
    category: Optional[str] = Field(default=None, description="Phân loại tài liệu (VD: HR, IT)")
